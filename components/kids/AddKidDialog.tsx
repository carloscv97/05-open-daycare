    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#3f362e]/35 p-4 sm:p-6">
      <section aria-labelledby="add-kid-title" className="max-h-full w-full max-w-[520px] overflow-y-auto rounded-[24px] border border-[#ece0d0] bg-[#fbf4ec] shadow-[0_20px_50px_-24px_rgba(63,54,46,0.35)]">
        <header className="flex items-center justify-between border-b border-[#ece0d0] px-5 py-5 sm:px-[26px]">
          <button type="button" className="text-[15px] font-bold text-[#94887b]">Cancelar</button>
          <h2 id="add-kid-title" className="font-display text-[18px] font-semibold text-text">Agregar niño</h2>
          <button type="button" className="text-[15px] font-extrabold text-coral-dark">Guardar</button>
        </header>
        ...
        <form className="p-5 sm:p-[26px]">
          <label className="mb-[18px] block">
            ...
            <input name="fullName" placeholder="Ej. Martina López" className="w-full rounded-[14px] border-[1.5px] border-[#eadfd0] bg-white px-4 py-[13px] text-[15px] text-text outline-none placeholder:text-[#b6a99b]" />
          </label>
          ...
          <div className="mb-[18px] grid gap-[18px] sm:grid-cols-2 sm:gap-[14px]">
            <label>
              ...
              <input name="birthDate" placeholder="dd/mm/aaaa" className="w-full rounded-[14px] border-[1.5px] border-[#eadfd0] bg-white px-4 py-[13px] text-[15px] text-text outline-none placeholder:text-[#b6a99b]" />
            </label>

            <label>
              <span className="mb-2 block text-[12px] font-extrabold tracking-[0.7px] text-[#94887b]">SALA</span>
              <select name="room" defaultValue="" className="w-full rounded-[14px] border-[1.5px] border-[#eadfd0] bg-white px-4 py-[13px] text-[15px] font-bold text-text outline-none">
          ...
          <label className="mb-[18px] block">
            ...
            <input name="allergies" placeholder="Ej. Maní, Lactosa" className="w-full rounded-[14px] border-[1.5px] border-[#eadfd0] bg-white px-4 py-[13px] text-[15px] text-text outline-none placeholder:text-[#b6a99b]" />
          </label>

          <label className="block">
            <span className="mb-2 block text-[12px] font-extrabold tracking-[0.7px] text-[#94887b]">NOTAS MÉDICAS</span>
            <textarea name="medicalNotes" placeholder="Indicaciones, medicación, contactos…" className="min-h-[90px] w-full resize-y rounded-[14px] border-[1.5px] border-[#eadfd0] bg-white px-4 py-[13px] text-[15px] leading-[1.5] text-text outline-none placeholder:text-[#b6a99b]" />
          </label>
        </form>
      </section>
    </div>
